package com.pi4j.component.display.impl.pcd8544;
 ...
 */
public class PCD8544Constants {

    public enum SysCommand implements Command {
        /** Display control. */
        DISPLAY(0x08), 
        /** Function set */
        FUNC   (0x20),
    ...
    public enum Setting implements Command {
