...
public class ZoomGSeries extends ZoomPedal {
	 ...
	 */
	protected ZoomGSeries(int sizePatchs, int totalEffects) {
		Patch patch = null;
		List<Effect> effects = this.createEffects(totalEffects);
	...
	/**
	 * TODO - Fazer todas as mensagens customizadas passarem por aqui
